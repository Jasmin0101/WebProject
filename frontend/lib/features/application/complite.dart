...
class CompliteApplicationWidget extends StatefulWidget {
  const CompliteApplicationWidget({super.key});

  @override
  State<CompliteApplicationWidget> createState() =>
      _CompliteApplicationWidgetState();
}

class _CompliteApplicationWidgetState extends State<CompliteApplicationWidget> {
